...
11. **Write a SQL query to find Which day of the week generates the most revenue?**:
```sql
SELECT 
...
11. **Write a SQL query to find Which age group contributes the most to sales?**:
```sql
SELECT 
    CASE 
